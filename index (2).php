...
/*
Source code author: @jahanbots
My channel: https://t.me/jahanbots
...
$token  = "6684274267:AAHpep56AaUMBG48usQwKT_-QZFt5FYb1Os"; //توکن
$admin = "6087985837"; //ایدی عددی ادمین
$dev = "jahanbots";  //یوزرنیم ادمین بدون @
...
if(!file_exists("data/@jahanbots.txt")){
    file_put_contents("data/@jahanbots.txt", "false");
}
...
$iamjahanbots = file_get_contents ("data/@jahanbots.txt");

if($iamjahanbots == "false"){
sendmessage ($admin , $help);
file_put_contents ("data/@jahanbots.txt","true");
}
